...
``` ts 
import makeWASocket from '@Villagerindo/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@Villagerindo/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@Villagerindo/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@Villagerindo/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@Villagerindo/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@Villagerindo/baileys'
                                */
...
import { downloadMediaMessage } from '@Villagerindo/baileys'
